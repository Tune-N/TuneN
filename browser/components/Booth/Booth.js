...
export default class extends React.Component {
  ...
  render(){
    ...
    <Scene>
      ...
      <SongBox text="Howdyy" textColor="black" boxColor="white" position="0 2 -2" width="1.50" height="0.5"/>

      <SongBox text="Howdyy2" textColor="black" boxColor="white" position="0 1 -2" width="1.50" height="0.5"/>
